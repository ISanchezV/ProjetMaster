namespace GameCreator.ModuleManager
{
    ...
    public abstract class ModuleManagerContent
    {
        ...
        public static void PaintProjectModule(ModuleManifest manifest)
        {
            ...
            if (GUILayout.Button("Backup", ModuleManagerContent.GetLargeButtonLeft()))
            {
            ...
            if (GUILayout.Button("Update", ModuleManagerContent.GetLargeButtonRight()))
            {
            ...
            if (!isEnabled && GUILayout.Button("Enable", ModuleManagerContent.GetLargeButtonLeft()))
            {
                ModuleManager.Enable(manifest);
            }

            if (isEnabled && GUILayout.Button("Disable", ModuleManagerContent.GetLargeButtonLeft()))
            {
        ...
        private static void PaintModule(Module module)
        {
            ...
            {
                if (GUILayout.Button(module.tags[i], EditorStyles.helpBox))
                {
                    ModuleManager.OpenStoreTag(module.tags[i]);
                }
            }
