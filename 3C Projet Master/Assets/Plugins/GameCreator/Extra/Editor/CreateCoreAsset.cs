...
namespace GameCreator.Core
{
	...
	public class CreateCoreAsset
	{
		...
		private const string ACTION_TEMPLATE_FILE = "ActionTemplate.cs";
		private const string ACTION_EXAMPLE_NAME = "NewAction.cs";

		private const string CONDITION_TEMPLATE_FILE = "ConditionTemplate.cs";
