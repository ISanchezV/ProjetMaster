namespace GameCreator.Variables
{
    ...
    {
        private const bool SAVE_BY_DEFAULT = false;
        ...
        [SerializeField] private VariableTrn varTrn = new VariableTrn();
        [SerializeField] private VariableRbd varRbd = new VariableRbd();
        ...
        public Variable(Variable variable)
        {
            ...
            this.varTrn = variable.varTrn;
            this.varRbd = variable.varRbd;
        }
        ...
        public object Get()
        {
            switch ((DataType)this.type)
            {
                ...
                case DataType.Transform: return this.varTrn.Get();
                case DataType.Rigidbody: return this.varRbd.Get();
            }
        ...
        public bool CanSave()
        {
            switch ((DataType)this.type)
            {
                ...
                case DataType.Transform: return this.varTrn.CanSave();
                case DataType.Rigidbody: return this.varRbd.CanSave();
            }
