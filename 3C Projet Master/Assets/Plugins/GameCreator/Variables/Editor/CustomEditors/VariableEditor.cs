namespace GameCreator.Variables
{
    ...
    public class MBVariableEditor : VariableEditor 
    {
        ...
        protected override Variable GetRuntimeVariable()
        {
    ...
    public abstract class VariableEditor : Editor
    {
        ...
        protected abstract Variable GetRuntimeVariable();
        ...
        private void PaintCommon()
        {
            ...
            bool isPrefab = PrefabUtility.GetPrefabType(this.target) == PrefabType.Prefab;
            bool canSave = this.CanSave() && !isPrefab;
            if (!canSave && this.spVariableSave.boolValue) this.spVariableSave.boolValue = false;
        ...
        private void PaintValue()
        {
            switch ((Variable.DataType)this.spVariableType.intValue)
            {
                ...
                case Variable.DataType.Transform: this.PaintProperty(this.spVariableTrn); break;
                case Variable.DataType.Rigidbody: this.PaintProperty(this.spVariableRbd); break;
            }
        }
        ...
        private void PaintRuntimeValue()
        {
            object variable = this.GetRuntimeVariable().Get();
            Rect rect = GUILayoutUtility.GetRect(
                EditorGUIUtility.fieldWidth + EditorGUIUtility.fieldWidth,
                EditorGUIUtility.singleLineHeight
            );
