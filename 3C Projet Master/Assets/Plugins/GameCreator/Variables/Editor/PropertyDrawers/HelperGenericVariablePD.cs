namespace GameCreator.Variables
{
    ...
    {
        private const float INDENT_WIDTH = 30f;
        ...
        private Rect GetRectLabel(Rect rect)
        {
            return new Rect(
                rect.x,
                rect.y,
                (EditorGUIUtility.labelWidth - EditorGUI.indentLevel * INDENT_WIDTH),
                rect.height
            );
        }
        ...
        {
            return new Rect(
                rect.x + (EditorGUIUtility.labelWidth - EditorGUI.indentLevel * INDENT_WIDTH),
                rect.y,
                rect.width - (EditorGUIUtility.labelWidth - EditorGUI.indentLevel * INDENT_WIDTH),
                rect.height
            );
        }
    }
