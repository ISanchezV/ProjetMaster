    ...
    public class DatabaseQuestsEditor : IDatabaseEditor
    {
        ...
        private void DeleteItems(List<int> items)
        {
            ...
            for (int i = 0; i < items.Count; ++i)
            {
				...
				{
					UnityEngine.Object reactions = PrefabUtility.GetPrefabObject(instance.reactions);
        ...
        public void MoveItemTo(TreeViewItem draggedItem, TreeViewItem parent, int insertIndex)
        {
            ...
            if (parentQuestItem != null)
            {
                ...
                spParentQuestItemChildren.serializedObject.ApplyModifiedProperties();
                ...
                spDraggedQuestItem.ApplyModifiedProperties();
		...
		public string RenameItem(int itemID, string name)
		{
			...
			this.questsEditors[itemID].serializedObject.ApplyModifiedProperties();
