namespace GameCreator.Camera
{
	...
	public class CameraMotorTypeRailway : ICameraMotorType 
	{
        ...
        public override void UpdateMotor()
        {
            ...
            Vector3 projection = Vector3.Project(aVector, bVector);

            float sign = Mathf.Sign(Vector3.Dot(projection, bVector));
            float t = projection.magnitude / bVector.magnitude * sign;
        ...
        {
            return this.target.GetDirection(this.cameraHead);
        }
	}
}