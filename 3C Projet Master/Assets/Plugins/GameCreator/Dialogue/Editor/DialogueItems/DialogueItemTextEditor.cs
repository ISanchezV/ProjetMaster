namespace GameCreator.Dialogue
{
    ...
    public class DialogueItemTextEditor : IDialogueItemEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            /*
            if (!DialogueEditor.IsWideScreen())
            {
                this.PaintOptions();
                switch (this.optionsIndex)
                {
                    case 0: this.PaintOptionContent(); break;
                    case 1: this.PaintOptionFlow(); break;
                    case 2: this.PaintOptionSettings(); break;
                }
            }
            else
            {
                EditorGUILayout.BeginHorizontal();
                this.PaintOptionContent();
                this.PaintOptionFlow();
                this.PaintOptionSettings();
        ...
        public static void AddElement(DialogueEditor dialogueEditor)
        {
            ...
            for (int i = 0; i < selections.Count; ++i)
            {
                ...
                dialogueEditor.serializedObject.ApplyModifiedProperties();
