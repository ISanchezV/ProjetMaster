namespace GameCreator.Dialogue
{
    ...
    public class DialogueTreeView : TreeView
    {
        ...
        private static GUIContent ICON_CONTENT_EXIT;
        private static GUIContent ICON_CONTENT_JUMP;
        ...
        private static GUIContent GetIcon(string iconName)
        {
            ...
            return new GUIContent("", AssetDatabase.LoadAssetAtPath<Texture2D>(path));
        }
