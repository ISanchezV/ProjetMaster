namespace GameCreator.Core
{
	...
	public class ActionVolume : IAction 
	{
        ...
        {
            if (this.changeMusicVolume) AudioManager.Instance.SetGlobalMusicVolume(this.volume);
            if (this.changeSoundVolume) AudioManager.Instance.SetGlobalSoundVolume(this.volume);
            return true;
        }
