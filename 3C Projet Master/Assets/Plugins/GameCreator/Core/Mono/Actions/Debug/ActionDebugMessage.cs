namespace GameCreator.Core
{
	...
	public class ActionDebugMessage : IAction 
	{
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            switch (this.logType)
            {
                case LogType.NORMAL: Debug.Log(this.message); break;
                case LogType.WARNING: Debug.LogWarning(this.message); break;
                case LogType.ERROR: Debug.LogError(this.message); break;
            }
