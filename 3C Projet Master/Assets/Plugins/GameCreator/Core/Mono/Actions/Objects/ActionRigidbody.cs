namespace GameCreator.Core
{
	...
	{
        public TargetRigidbody target = new TargetRigidbody();
        ...
        {
            Rigidbody targetRB = this.target.GetRigidbody(target);
            if (targetRB != null)
            {
                targetRB.mass = this.mass.GetValue();
                targetRB.useGravity = this.useGravity.GetValue();
                targetRB.isKinematic = this.isKinematic.GetValue();
            }
