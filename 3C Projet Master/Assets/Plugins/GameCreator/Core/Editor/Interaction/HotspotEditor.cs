	...
	public class HotspotEditor : Editor 
	{
		...
		private void OnSceneGUI()
		{
			if (this.spProximEnabled.boolValue)
			{
				...
				this.spProximRadius.floatValue = Mathf.Clamp(this.spProximRadius.floatValue, 1.0f, 20.0f);
			...
			if (this.spHeadTrEnabled.boolValue)
			{
				...
				this.spHeadTrRadius.floatValue = Mathf.Clamp(this.spHeadTrRadius.floatValue, 1.0f, 20.0f);
