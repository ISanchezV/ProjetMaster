		...
		private class NodeData
		{
			...
			public NodeData(string content, Type component = null)
			{
				...
				else
				{
					...
					FieldInfo customIconsFieldInfo = component.GetField(CUSTOM_ICON_PATH_VARIABLE);
					...
					icon = AssetDatabase.LoadAssetAtPath<Texture2D>(iconsPath + content + ".png");
				...
				this.content = new GUIContent(" " + content, icon);
