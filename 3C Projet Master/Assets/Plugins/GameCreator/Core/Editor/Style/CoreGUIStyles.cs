namespace GameCreator.Core
{
	...
	public abstract class CoreGUIStyles
	{
		...
		public static GUIStyle GetDropMarker()
		{
			...
			{
				CoreGUIStyles.dropMark = new GUIStyle(GUI.skin.FindStyle("PR Insertion Above"));
			}
		...
		public static GUIStyle GetBox()
		{
			...
			{
				CoreGUIStyles.box = new GUIStyle(GUI.skin.box);
				CoreGUIStyles.box.margin = new RectOffset(0,0,0,0);
				CoreGUIStyles.box.padding = new RectOffset(1,1,1,0);
			}
		...
		public static GUIStyle GetToolbarButton()
		{
			...
			{
				CoreGUIStyles.btnToolbar = new GUIStyle(GUI.skin.FindStyle("toolbarbutton"));
			}
