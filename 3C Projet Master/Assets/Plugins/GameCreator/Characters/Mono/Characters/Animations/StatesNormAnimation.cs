...
public class StatesNormAnimation
{
    ...
    public void SetState(RuntimeAnimatorController rtc, float weight, float time)
    {
        this.SetState(
    ...
    public void SetState(AnimationClip clip, float weight, float time)
    {
        this.SetState(
    ...
    private void SetState(Playable input, float weight, float time)
    {
