...
public class StatesMaskAnimation
{
    ...
    public void SetState(RuntimeAnimatorController rtc, AvatarMask mask, float weight, float time)
    {
        this.SetState(
    ...
    public void SetState(AnimationClip clip, AvatarMask mask, float weight, float time)
    {
        this.SetState(
