namespace GameCreator.Characters
{
	...
	public class ActionCharacterFollow : IAction 
	{
        ...
        public TargetTransform followTarget = new TargetTransform();
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            ...
            Transform follow = (this.actionType == ActionType.Follow
                ? this.followTarget.GetTransform(target)
                : null
            );
        ...
        private const string NODE_TITLE = "{0} character {0}";
