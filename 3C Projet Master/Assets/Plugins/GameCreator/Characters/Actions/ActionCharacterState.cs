namespace GameCreator.Characters
{
    ...
    public class ActionCharacterState : IAction
    {
        ...
        [Range(0f, 2f)] public float transitionTime = 0.25f;
        ...
        public override bool InstantExecute(GameObject target, IAction[] actions, int index)
        {
            ...
            if (charTarget != null && charTarget.GetCharacterAnimator() != null)
            {
                ...
                {
                    RuntimeAnimatorController rtc = this.stateAsset.GetRuntimeAnimatorController();
                    if (rtc != null) charTarget.GetCharacterAnimator().SetState(
                        rtc,
                        avatarMask,
                        this.weight,
                        this.transitionTime,
